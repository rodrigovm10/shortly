...
export const TypographyH1 = forwardRef<HTMLHeadingElement, React.ComponentPropsWithoutRef<'h1'>>(
  ({ className, ...props }, ref) => {
    return (
      <h1
        ref={ref}
        className={cn('mt-6 text-5xl font-bold tracking-tight lg:text-6xl', className)}
        {...props}
      />
    )
  }
...
export const TypographyH3 = forwardRef<HTMLHeadingElement, React.ComponentPropsWithoutRef<'h3'>>(
  ({ className, ...props }, ref) => {
    return (
      <h3
        ref={ref}
        className={cn('mt-6 text-3xl font-bold tracking-tight lg:text-4xl', className)}
        {...props}
      />
    )
  }
...
export const TypographyH4 = forwardRef<HTMLHeadingElement, React.ComponentPropsWithoutRef<'h4'>>(
  ({ className, ...props }, ref) => {
    return (
      <h4
        ref={ref}
        className={cn('mt-2 text-2xl font-semibold tracking-tight lg:text-3xl', className)}
        {...props}
      />
    )
  }
...
export const TypographyP = forwardRef<HTMLParagraphElement, React.ComponentPropsWithoutRef<'p'>>(
  ({ className, ...props }, ref) => {
    return (
      <p
        ref={ref}
        className={cn('text-pretty leading-7 [&:not(:first-child)]:mt-4', className)}
        {...props}
      />
    )
  }
